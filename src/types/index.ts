...
export const UNIDADES_ESCOLARES = [
  'ANTONIO T R DE OLIVEIRA, C E-EF M',
  'NILO CAIRO, C E-EF M N PROFIS',
  'UNIDADE POLO, C E-EF M PROFIS',
  'LEOCADIA B RAMOS, C E-EF M PROFIS',
  'MATHIAS JACOMEL, C E-EF M PROFIS',
  'ANIBAL KHURY NETO, C E-EF M PROFIS',
  'ELIAS ABRAHAO, C E PROF-EF M PROFIS',
  'HILDEBRANDO DE ARAUJO, C E-EF M PROFIS',
  'NATALIA REGINATO, C E-EF M PROFIS',
  'OLIVIO BELICH, C E DEP-EF M',
  'AYRTON SENNA DA SILVA, C E-EF M N PROFIS',
  'GUSTAVO D DA SILVA, C E-EF M PROFIS',
  'JUSCELINO K DE OLIVEIRA, C E-EFMPN',
  'TAMANDARE, C E ALM-EF M PROFIS',
  'RUI BARBOSA, C E C-EF M',
  'BELO HORIZONTE, C E-EF M PROFIS',
  'DURVAL RAMOS FILHO, C E-EF M PROFIS',
  'GERALDO FERNANDES, C E D-EF M',
  'JARDIM SAN RAFAEL, C E DO-EF M',
  'KAZUCO OHARA, E E PROF-EF',
  'NOSSA SRA LOURDES, C E-EF M',
  'UBEDULHA C OLIVEIRA, C E PROFA-EF M P N',
  'WILLIE DAVIDS, C E DR-EF M',
  'AMANDA CARNEIRO DE MELLO, C E-EF M PROFI',
  'FRITZ KLIEWER, C E C-EF M',
  'JORGE Q NETTO C E EF M PROFIS',
  'ANA DIVANIR BORATTO, C E-EFM',
  'ARNALDO JANSEN, C E PE-EF M PROFIS',
  'CORREIA, C E SEN-EF M PROFIS',
  'FRANCISCO PIRES MACHADO, C E-EF M PROFIS',
  'LINDA S BACILA, C E PROFA-EF M PROFIS',
  'RODRIGUES ALVES, C E-EF M N PROFIS',
] as const;

export const UNIDADE_MAPEADA: Record<typeof UNIDADES_ESCOLARES[number], string> = {
  'ANTONIO T R DE OLIVEIRA, C E-EF M': 'ANTONIO T R DE OLIVEIRA C E EF M',
  'NILO CAIRO, C E-EF M N PROFIS': 'NILO CAIRO C E EF M N PROFIS',
  'UNIDADE POLO, C E-EF M PROFIS': 'UNIDADE POLO C E EF M PROFIS',
  'LEOCADIA B RAMOS, C E-EF M PROFIS': 'LEOCADIA B RAMOS C E EF M PROFIS',
  'MATHIAS JACOMEL, C E-EF M PROFIS': 'MATHIAS JACOMEL C E EF M PROFIS',
  'ANIBAL KHURY NETO, C E-EF M PROFIS': 'ANIBAL KHURY NETO C E EF M PROFIS',
  'ELIAS ABRAHAO, C E PROF-EF M PROFIS': 'ELIAS ABRAHAO C E PROF EF M PROFIS',
  'HILDEBRANDO DE ARAUJO, C E-EF M PROFIS': 'HILDEBRANDO DE ARAUJO C E EF M PROFIS',
  'NATALIA REGINATO, C E-EF M PROFIS': 'NATALIA REGINATO C E EF M PROFIS',
  'OLIVIO BELICH, C E DEP-EF M': 'OLIVIO BELICH C E DEP EF M',
  'AYRTON SENNA DA SILVA, C E-EF M N PROFIS': 'AYRTON SENNA DA SILVA C E EF M N PROFIS',
  'GUSTAVO D DA SILVA, C E-EF M PROFIS': 'GUSTAVO D DA SILVA C E EF M PROFIS',
  'JUSCELINO K DE OLIVEIRA, C E-EFMPN': 'JUSCELINO K DE OLIVEIRA C E EFMPN',
  'TAMANDARE, C E ALM-EF M PROFIS': 'TAMANDARE C E ALM EF M PROFIS',
  'RUI BARBOSA, C E C-EF M': 'RUI BARBOSA C E C EF M',
  'BELO HORIZONTE, C E-EF M PROFIS': 'BELO HORIZONTE C E EF M PROFIS',
  'DURVAL RAMOS FILHO, C E-EF M PROFIS': 'DURVAL RAMOS FILHO C E EF M PROFIS',
  'GERALDO FERNANDES, C E D-EF M': 'GERALDO FERNANDES C E D EF M',
  'JARDIM SAN RAFAEL, C E DO-EF M': 'JARDIM SAN RAFAEL C E DO EF M',
  'KAZUCO OHARA, E E PROF-EF': 'KAZUCO OHARA E E PROF EF',
  'NOSSA SRA LOURDES, C E-EF M': 'NOSSA SRA LOURDES C E EF M',
  'UBEDULHA C OLIVEIRA, C E PROFA-EF M P N': 'UBEDULHA C OLIVEIRA C E PROFA EF M P N',
  'WILLIE DAVIDS, C E DR-EF M': 'WILLIE DAVIDS C E DR EF M',
  'AMANDA CARNEIRO DE MELLO, C E-EF M PROFI': 'AMANDA CARNEIRO DE MELLO C E EF M PROFI',
  'FRITZ KLIEWER, C E C-EF M': 'FRITZ KLIEWER C E C EF M',
  'JORGE Q NETTO C E EF M PROFIS': 'JORGE Q NETTO C E EF M P N',
  'ANA DIVANIR BORATTO, C E-EFM': 'ANA DIVANIR BORATTO C E EFM',
  'ARNALDO JANSEN, C E PE-EF M PROFIS': 'ARNALDO JANSEN C E PE EF M PROFIS',
  'CORREIA, C E SEN-EF M PROFIS': 'CORREIA C E SEN EF M PROFIS',
  'FRANCISCO PIRES MACHADO, C E-EF M PROFIS': 'FRANCISCO PIRES MACHADO C E EF M PROFIS',
  'LINDA S BACILA, C E PROFA-EF M PROFIS': 'LINDA S BACILA C E PROFA EF M PROFIS',
  'RODRIGUES ALVES, C E-EF M N PROFIS': 'RODRIGUES ALVES C E EF M N PROFIS',
};
